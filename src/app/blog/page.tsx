          ...
          <div className="relative max-w-[1400px] mx-auto px-6 lg:px-12 w-full">
            ...
            >
              <p className="text-lg md:text-xl text-white/70 leading-relaxed">
                Kita lagi siapin artikel-artikel actionable seputar SEO,
                Ads, Web Development, dan AI untuk bisnis Indonesia. Subscribe
                untuk dapet notifikasi pas konten pertama launch.
              </p>
              ...
              <div className="mt-10">
                ...
                >
                  <span>Subscribe untuk update</span>
