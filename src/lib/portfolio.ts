...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  // ============================================================
  {
    ...
    challenge:
      "Site lama membuat lambat (LCP > 5 detik), checkout 4-step yang membuat cart abandonment 78%, dan integrasi inventory manual antara warehouse Bandung & dropshipper. Pas peak campaign 12.12, server down 3 kali.",
    approach:
      "Migrasi penuh ke Shopify Plus dengan custom theme bawaan kami, integrasi Mekari Jurnal untuk akuntansi, dan checkout 1-page. Setup Klaviyo untuk email flow + Meta Conversions API untuk attribution yang akurat. Soft launch ke 10% traffic dulu, monitor 2 minggu, baru full rollout.",
    results: [
  ...
  },
  {
    ...
    duration: "6 minggu",
    summary:
      "Website corporate dengan tone serius tetapi modern. Khusus targeting C-level clients di sektor korporat & M&A.",
    challenge:
      "Site lama (WordPress template) membuat kesan firm-nya kecil padahal partnernya senior eks Big Four. Lawyer junior tidak ada brand profile sendiri, dan publikasi/insight tidak ke-index Google sama sekali.",
    approach:
    ...
    results: [
      {
        metric: "Inbound inquiry",
        value: "+340%",
        note: "form contact + email",
      },
  ...
  },
  {
    ...
    approach:
      "Build custom marketplace di Next.js + Strapi headless CMS. Onboarding vendor via WhatsApp form, payment via Xendit + COD ke kurir lokal regional, dan training offline ke 12 kota. Sistem moderasi produk dengan AI image classifier untuk filter konten yang tidak sesuai.",
    results: [
      ...
      {
        metric: "Avg vendor income",
        value: "+Rp 1.8jt/bulan",
        note: "vs offline only",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Launching produk serum baru dengan budget ads Rp 350jt dalam 2 minggu. Landing page lama (di Tokopedia) tidak convert karena terlalu generic, dan founder ingin ngecek mana value proposition yang paling resonate.",
    approach:
      "Buat 4 varian landing page dengan headline + visual + offer berbeda. Setup AB test pakai Vercel Edge Config (no flicker), event tracking ke GA4 + Meta. Tim creative membuat 16 ad creative (4 per varian) untuk fairness test. Iterasi mingguan dengan winner kompounding.",
    results: [
  ...
  },
  {
    ...
    challenge:
      "Operator tour dengan 40+ paket + 120+ reseller agent kelola booking via WhatsApp + Excel. Sering double booking, harga reseller tidak terupdate, dan financial reporting bulanan butuh 4 hari kerja.",
    approach:
    ...
    results: [
      {
        metric: "Booking processing time",
        value: "3 menit",
        note: "dari 35 menit",
      },
      { metric: "Double booking incident", value: "0", note: "dalam 6 bulan" },
      {
        metric: "Active reseller agent",
        value: "+58%",
        note: "168 → 265 agent",
      },
  ...
  },
  {
    ...
    challenge:
      "7 cabang dengan kapasitas + slot dokter berbeda-beda. Pasien sering datang ke cabang yang full atau dokternya tidak available. Tim admin spend 6+ jam/hari hanya untuk reschedule via WhatsApp.",
    approach:
  ...
  },
  {
    ...
    challenge:
      "Project township gede dengan banyak fase + cluster. Lead form tidak dirouting dengan baik (banyak yang ke-pickup agent yang sudah resign), floor plan masih PDF download, dan virtual tour pakai vendor luar yang tidak terintegrasi.",
    approach:
  ...
  },
  {
    ...
    challenge:
      "EdTech grow cepat tetapi pakai Teachable yang limit di customization + biaya per-student mahal. Drop off rate 38% di kelas live karena UX live class kurang intuitive, dan tracking progress siswa terpisah-pisah.",
    approach:
  ...
  },
  {
    ...
    challenge:
      "Booking via OpenTable terlalu generic + ada commission tinggi. Customer VIP tidak ke-recognize, special request (alergi, special occasion) sering ke-miss, dan waitlist management masih via WhatsApp manual.",
    approach:
      "Build booking system custom dengan tier member VIP recognition, slot reservation dengan deposit, intelligent waitlist (auto-fill jika ada cancel), dan integrasi POS untuk track repeat customer + preferensi menu. Concierge tablet UI untuk staff host.",
    results: [
      { metric: "Direct booking", value: "78%", note: "lepas dari OpenTable" },
      {
        metric: "Booking commission saved",
        value: "Rp 280jt/tahun",
        note: "OpenTable fee",
      },
  ...
  },
  {
    ...
    challenge:
      "Startup HR SaaS lagi scale dari 12 ke 180+ klien enterprise. Frontend lama (React class component) tidak scalable, performance lag di company yang punya 5.000+ karyawan, dan setup tenant baru butuh 2 hari manual.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Eng team velocity",
        value: "+2.3x",
        note: "ship feature/sprint",
      },
    ],
  ...
  // ============================================================
  {
    ...
    approach:
      "Buat PWA fast install (<3 detik) dengan Add to Home Screen prompt, smart slot recommendation berdasarkan history customer, dan stylist preference matching. Push notif untuk reminder + promo. Sinkron ke sistem POS existing untuk member tier.",
    results: [
      ...
      {
        metric: "Dev cost saved",
        value: "Rp 480jt",
        note: "vs native dual platform",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Gym premium dengan member fee Rp 2.5jt/bulan tetapi engagement post-onboarding turun drastis bulan ke-3. Class booking penuh jam prime time, member tidak tahu progress mereka, dan trainer matching masih manual via WhatsApp.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Member retention 12mo",
        value: "+38%",
        note: "engagement effect",
      },
  ...
  },
  {
    ...
    challenge:
      "Founder punya 60+ cleaner di Jabodetabek tetapi job assignment masih via grup WhatsApp. Customer susah track cleaner mana yang dateng, sering complaint cleaner tidak punya skill expected, dan rating system tidak ada.",
    approach:
      "Build 3 app: customer (booking + tracking), cleaner (job board + earning), admin (dispatch + dispute). Cleaner profile dengan certification badge, geolocation real-time saat cleaning, dan rating + reward sistem. Payment escrow via Xendit.",
    results: [
  ...
  },
  {
    ...
    challenge:
      "Petani sayur di Malang punya hasil panen yang sering kebuang karena demand market tidak match. Hotel/restoran beli via tengkulak dengan harga 3-5x lipat. Founder mau cut middleman tetapi butuh sistem yang memahami B2B (NPWP, faktur pajak, term payment).",
    approach:
    ...
    results: [
      ...
      {
        metric: "Buyer aktif (hotel+resto)",
        value: "189",
        note: "Jatim + Bali",
      },
  ...
  },
  {
    ...
    challenge:
      "Founder ex-pendidik membuat kurikulum bagus tetapi parent ngeluh anak bosen di sesi ke-3. Anak fokus 8-10 menit saja, parent tidak bisa track progress harian, dan offline learning tidak available (banyak family yang travel).",
    approach:
    ...
    results: [
      ...
      {
        metric: "Subscriber retention 6mo",
        value: "78%",
        note: "industry 35-45%",
      },
  ...
  },
  {
    ...
    challenge:
      "Coffee chain sudah punya 48 cabang tetapi customer data tersebar di POS per outlet. Repeat customer tidak ke-recognize lintas cabang, promo via flyer mahal + tidak measurable, dan antrian peak hour membuat lost sales.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Repeat rate member",
        value: "4.2x/bulan",
        note: "vs 1.7x non-member",
      },
  ...
  },
  {
    ...
    challenge:
      "Network klinik mau ekspansi telemedicine post-COVID tetapi pakai vendor third-party yang revenue share-nya 25%. Dokter ngeluh UX vendor susah, prescription manual scan, dan integrasi ke lab partner tidak ada.",
    approach:
    ...
    results: [
      {
        metric: "Konsultasi/bulan",
        value: "8.400",
        note: "dari 1.200 di vendor lama",
      },
  ...
  },
  {
    ...
    challenge:
      "Developer punya 1.200+ marketing agent yang akses inventory + brosur via Google Drive. File outdated, agent senior dapatkan info lebih cepat dari junior, dan submission booking masih via WhatsApp ke project leader.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Booking submit time",
        value: "<2 menit",
        note: "dari 25 menit WA",
      },
      {
        metric: "Brosur production cost",
        value: "-Rp 180jt/bulan",
        note: "vs cetak",
      },
  ...
  },
  {
    ...
    challenge:
      "Logistik dengan 280 driver kelola pengiriman B2B (consumer goods ke retail) lewat WhatsApp + paper manifest. Route membuat sendiri sopir-driver (inefisien), proof of delivery foto via WhatsApp ke admin (4 jam/hari pekerjaan admin), dan COD reconciliation manual.",
    approach:
    ...
    results: [
      {
        metric: "Delivery/hari per driver",
        value: "+34%",
        note: "route optimization",
      },
      {
        metric: "Admin reconciliation time",
        value: "30 menit",
        note: "dari 4 jam",
      },
  ...
  },
  {
    ...
    challenge:
      "Koperasi karyawan dengan 8.000+ anggota masih kelola simpan pinjam manual via Excel + transfer bank. Payroll cut otomatis bermasalah dengan finance company induk, dan anggota muda ngeluh seperti banking jadul.",
    approach:
    ...
    results: [
      {
        metric: "Aktif user 6mo",
        value: "6.840 anggota",
        note: "86% conversion",
      },
      {
        metric: "Saldo terkelola",
        value: "Rp 28M",
        note: "dari Rp 4M tahun lalu",
      },
  ...
  // ============================================================
  {
    ...
    challenge:
      "F&B chain 18 cabang pakai Moka POS tetapi limit di customization menu (combo, modifier, time-based price), inventory antar cabang tidak realtime (stock-out di cabang A padahal cabang B excess), dan reporting butuh export excel manual.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Software license saved",
        value: "Rp 156jt/tahun",
        note: "vs Moka",
      },
    ],
  ...
  },
  {
    ...
    duration: "18 minggu",
    summary:
      "CRM custom untuk lead management + agent + booking properti. Replace Excel + Trello + spreadsheet komisi.",
    challenge:
      "Developer dengan 5 project aktif kelola lead via Excel, agent task via Trello, dan komisi via spreadsheet manual. Lead expired tidak ke-follow (avg response time 38 jam), komisi sering wrong calc (banyak komplain agent), dan handover sales-finance manual.",
    approach:
  ...
  },
  {
    ...
    challenge:
      "Klinik jaringan 22 cabang pakai SIM lama (vendor close source) yang slow + tidak ada API. Obat ekspirasi (kerugian Rp 300jt+/tahun) karena tidak ada FEFO tracking, antrian chaos, dan medical record per cabang tidak terkoneksi.",
    approach:
    ...
    results: [
      {
        metric: "Obat expired loss",
        value: "-94%",
        note: "Rp 300jt → Rp 18jt",
      },
      { metric: "Patient queue time", value: "-58%", note: "digital queue" },
      {
        metric: "Cross-cabang referral",
        value: "+220%",
        note: "EMR connected",
      },
  ...
  },
  {
    ...
    challenge:
      "Multifinance dengan portfolio Rp 1.2T butuh report bulanan ke OJK + Bank Indonesia. Tim compliance 6 orang spend full-time generate report via macro Excel. Sering miss deadline (denda Rp 25jt/bulan) dan data tidak konsisten antar report.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Tim compliance redirect",
        value: "4 orang",
        note: "ke risk advisory",
      },
  ...
  },
  {
    ...
    challenge:
      "Manufaktur tier-1 dengan 1.800 karyawan pakai HRIS standar tetapi workflow approval (cuti, lembur, promosi, separation) masih via email + paper. Approval cuti rata-rata 4 hari, performance review tahunan butuh 6 minggu, dan onboarding karyawan baru sering miss step.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Performance review cycle",
        value: "2 minggu",
        note: "dari 6 minggu",
      },
      {
        ...
        value: "100%",
        note: "checklist enforce",
      },
      {
        metric: "HR ops cost",
        value: "-Rp 420jt/tahun",
        note: "less manual ops",
      },
    ],
  ...
  },
  {
    ...
    approach:
      "WMS custom dengan barcode scanner Android, picking optimization algorithm, dan cycle counting (tidak perlu shutdown). Portal B2B untuk bengkel partner: order online, lihat stock realtime per gudang terdekat, dan delivery tracking. Integrasi ke accounting system existing.",
    results: [
      {
        metric: "Stock opname downtime",
        value: "0 jam",
        note: "cycle counting",
      },
  ...
  },
  {
    ...
    challenge:
      "Klinik gigi 8 cabang dengan 32 dokter. Booking masih via WhatsApp ke admin, recall pasien (rutin check-up 6 bulanan) tidak ada sistem (lupa banyak yang tidak balik), dan kelola antrian pakai buku tulis.",
    approach:
    ...
    results: [
      {
        metric: "Recall pasien aktif",
        value: "+412%",
        note: "auto-WA reminder",
      },
      { metric: "Booking-to-show", value: "94%", note: "dari 71%" },
      {
        metric: "Admin call time",
        value: "-78%",
        note: "self-service booking",
      },
      {
        metric: "Revenue per chair/hari",
        value: "+34%",
        note: "better utilization",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Yayasan dengan 6 sekolah pakai 3 sistem berbeda (TK pakai SaaS, SD-SMP-SMA pakai built-in lawas, finance terpisah). Komunikasi orang tua via WA grup 60+ orang. Tagihan SPP banyak yang miss (telat) tetapi sistem reminder manual.",
    approach:
      "SMS custom unified untuk 6 unit dengan fitur: akademik (rapor, absensi, jadwal), finance (SPP, ekskul, kegiatan + payment online), dan parent app (broadcast + personal message). Auto-reminder SPP H-7, H-3, H-0, H+1 + auto-pause akun siswa jika >3 bulan.",
    results: [
      ...
      {
        metric: "Yayasan cash flow",
        value: "+Rp 1.8M",
        note: "improved SPP timing",
      },
    ],
  ...
  },
  {
    ...
    results: [
      ...
      {
        metric: "Tour profitability visibility",
        value: "100%",
        note: "per tour",
      },
      {
        metric: "Currency loss",
        value: "-Rp 240jt/tahun",
        note: "live hedging info",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Direct selling skincare punya 12.000 reseller dengan struktur MLM binary. Sistem lama (hosted vendor) tidak scalable, lookup posisi reseller butuh 30+ detik, komisi calculation lambat (3 hari per cycle), dan jika ada bug kerusakan trust massive.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Reseller satisfaction",
        value: "NPS 71",
        note: "post-launch survey",
      },
    ],
  ...
  // ============================================================
  {
    ...
    challenge:
      "Developer launching cluster baru di BSD tetapi domain authority masih DA 18. Kompetitor 99.co, Rumah123, dan Pinhome dominate page 1 untuk keyword 'rumah BSD'. Content blog hanya 12 artikel low-effort.",
    approach:
  ...
  },
  {
    ...
    challenge:
      "Klinik kecantikan premium pakai ads saja (Rp 250jt/bulan) tetapi tidak ada organic moat. GBP 4 cabang masih default (foto sedikit, review 4.2, no posts), dan kompetitor besar (Erha, ZAP) dominate keyword utama.",
    approach:
  ...
  },
  {
    ...
    challenge:
      "Travel umroh tier-2 (omzet Rp 80M/tahun) compete dengan brand established (NRA, Maktour). Content masih thin (300-500 kata), tidak ada schema FAQ untuk featured snippet, dan trust signal weak (kompetitor punya media coverage).",
    approach:
  ...
  },
  {
    ...
    challenge:
      "Marketplace properti dengan 280rb URL listing aktif lagi migrasi dari custom CMS lama ke Next.js. Risk: jika migrasi tidak rapi, traffic SEO yang Rp 8M/bulan equivalent bisa hilang. Kompetitor (Rumah123, 99.co) lebih established.",
    approach:
    ...
    results: [
      {
        metric: "Traffic drop migrasi",
        value: "0%",
        note: "vs avg 30-50% loss",
      },
      { metric: "Organic growth 90d", value: "+28%", note: "vs baseline" },
      {
        metric: "Indexed pages",
        value: "278.400",
        note: "dari 312rb (cleanup)",
      },
  ...
  },
  {
    ...
    challenge:
      "Dealer mobil bekas dengan 800+ unit di 3 kota. Inventory berubah harian, tidak ada landing page per unit (semua di Tokopedia + OLX), dan dependent sama platform iklan. Kompetitor lokal sudah punya website mandiri.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Platform fee saved",
        value: "Rp 320jt/tahun",
        note: "OLX commission",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Restoran fine dining bagus (rating 4.9 di Google) tetapi reservasi 70% via OpenTable + Chope yang potong fee 8-12%. Organic search invisible (chef awards tidak ke-google), dan content SEO masih minimal.",
    approach:
    ...
    results: [
      {
        metric: "Top 3 'fine dining Jakarta'",
        value: "Achieved",
        note: "+ 14 keyword lain",
      },
      { metric: "Direct reservation", value: "78%", note: "dari 30%" },
      {
        metric: "OpenTable fee saved",
        value: "Rp 480jt/tahun",
        note: "commission",
      },
      {
        metric: "Avg ticket size organic",
        value: "+22%",
        note: "vs OpenTable user",
      },
    ],
  ...
  },
  {
    ...
    approach:
      "Bilingual SEO setup: hreflang tags, dedicated EN content (tidak translated), content strategy per persona (admission FAQ, curriculum comparison Cambridge vs IB). Authoritative content tentang Indonesian education landscape untuk expat parent.",
    results: [
  ...
  },
  {
    ...
    results: [
      {
        metric: "Position avg 'pinjol legal'",
        value: "1.4",
        note: "Top 1-2 stable",
      },
      ...
      {
        metric: "NPL rate organic users",
        value: "1.8%",
        note: "vs ads users 3.4%",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Vape e-commerce tidak bisa pakai Meta Ads (banned policy) + Google Ads terbatas (restricted). 100% growth depend on SEO + komunitas. Konten masih thin (deskripsi vendor copy-paste), kompetitor luar negeri (US) rank pakai backlink agresif.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Avg order value organic",
        value: "+47%",
        note: "vs paid (banned)",
      },
  ...
  },
  {
    ...
    challenge:
      "Konsultan pajak independent yang fokus SME compete dengan firm besar (Deloitte, KPMG, EY) + portal generic (klikpajak, mekari). Site lama 8 page, no blog, dan founder tidak punya brand authority online.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Conversion to client",
        value: "11%",
        note: "high-intent organic",
      },
      {
        metric: "Founder LinkedIn follower",
        value: "+8.400",
        note: "thought leadership",
      },
      {
        metric: "Revenue from organic",
        value: "Rp 2.1M/bulan",
        note: "client value avg",
      },
    ],
  ...
  // ============================================================
  {
    ...
    challenge:
      "Developer launching cluster baru (140 unit) dengan budget marketing Rp 2.5M. Lokasi premium (harga Rp 1.8-3.4M/unit) tetapi awareness rendah. Konversi dari online ads ke booking fee historically lemah (banyak leads tetapi tidak qualified).",
    approach:
    ...
    results: [
      ...
      {
        metric: "Cost per booking fee",
        value: "Rp 4.8jt",
        note: "ticket size Rp 2-3M",
      },
      {
        metric: "Unit sold 90 hari",
        value: "78/140",
        note: "phase 1 sold out",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Klinik LASIK premium dengan service price Rp 25-50jt/mata. Kompetitor utama (JEC, KMN) dominate Google Ads dengan budget besar. CPL klinik historical Rp 850rb, qualified conversion rate ke booking 12%, tidak ekonomis.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Market share Jakarta",
        value: "+18% est",
        note: "kompetitor brand search",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Coffee chain sudah launch loyalty app tetapi install slow (organic only). Target Gen-Z + young millennial. Meta Ads CPI tinggi (Rp 18rb), TikTok belum dicoba properly (hanya boost organic).",
    approach:
  ...
  },
  {
    ...
    challenge:
      "EdTech bahasa asing dengan paket Rp 2.5-5jt/level. Awareness banyak tetapi conversion dari ads ke paid susah. Funnel langsung 'beli paket' tidak work, trial class flow ada tetapi CPL historical Rp 95rb.",
    approach:
  ...
  },
  {
    ...
    results: [
      ...
      {
        metric: "First purchase conversion",
        value: "8.4%",
        note: "dari education traffic",
      },
      { metric: "Repeat purchase", value: "62%", note: "12 bulan retention" },
      {
        metric: "Avg ticket pertama",
        value: "Rp 4.8jt",
        note: "0.5-1g first buy",
      },
    ],
  ...
  },
  {
    ...
    results: [
      { metric: "MAU growth", value: "4.1x", note: "280k → 1.15M" },
      {
        metric: "CPI blended",
        value: "Rp 8.400",
        note: "industry avg Rp 24rb",
      },
      {
        metric: "D30 retention",
        value: "38%",
        note: "dari 18% pre-optimization",
      },
      {
        metric: "Consult per MAU",
        value: "+67%",
        note: "monetization improvement",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Dealer mobil network dengan 12 cabang di 6 kota. Lead via Facebook Ads tipe leadform tetapi quality jelek (banyak fake/test data), lead routing manual ke cabang terdekat sering miss (lead expire), dan attribution dari ads ke unit sold tidak jelas.",
    approach:
  ...
  },
  {
    ...
    results: [
      {
        metric: "Direct reservation",
        value: "82%",
        note: "dari OpenTable 30%",
      },
      { metric: "ROAS", value: "7.4x", note: "blended" },
      {
        metric: "New customer/bulan",
        value: "+340%",
        note: "first-time visit",
      },
      {
        metric: "Commission saved",
        value: "Rp 280jt/tahun",
        note: "OpenTable",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Vape brand premium tidak bisa pakai Meta/Google Search Ads (banned + restricted). YouTube Ads boleh tetapi creative restrict (no product showcase). Brand awareness rendah, organic search dominated by competitor lebih established.",
    approach:
    ...
    results: [
      ...
      {
        metric: "YouTube view rate",
        value: "42%",
        note: "industry avg 15-20%",
      },
      { metric: "Direct site traffic", value: "+340%", note: "brand recall" },
      {
        metric: "Market share online",
        value: "+12 ppt est",
        note: "vs kompetitor",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Casual game publisher launch game baru genre puzzle. Budget UA $50k/bulan untuk Indonesia + SEA. CPI historical $1.20 dengan retention D7 hanya 18%. Monetization model IAP + IAA hybrid. Butuh CPI turun + retention naik supaya payback period sehat.",
    approach:
  ...
  // ============================================================
  {
    ...
    challenge:
      "F&B casual dining 16 cabang dengan IG 32k follower (3 tahun stuck). Content masih foto menu still life + caption generic, engagement rate 0.8%. Owner ingin reposisi brand lebih playful + targeting Gen-Z, tetapi tim sosmed internal hanya 1 orang.",
    approach:
  ...
  },
  {
    ...
    challenge:
      "Skincare D2C brand 2-tahun, IG 84k follower tetapi engagement 1.2% (stale). Kompetitor baru bermunculan dengan growth rapid via TikTok. Founder ingin aktivasi UGC tetapi tidak tahu cara orchestrate scale.",
    approach:
  ...
  },
  {
    ...
    challenge:
      "Developer mixed-use besar dengan project residential + commercial. IG hanya posting brosur unit (tidak engaging), LinkedIn tidak ada akun aktif. Investor B2B inquiry tidak ada channel digital, semuanya offline via broker.",
    approach:
    ...
    results: [
      ...
      {
        metric: "LinkedIn follower CEO",
        value: "+12.400",
        note: "from scratch",
      },
      {
        metric: "B2B investor inquiry",
        value: "84/tahun",
        note: "via LinkedIn DM",
      },
  ...
  },
  {
    ...
    challenge:
      "Coding bootcamp dengan paket Rp 8-25jt belum scale CAC. Ads CAC Rp 1.4jt/student, butuh organic channel yang sustainable. Tim hanya 2 orang (founder + 1 socmed) tanpa pengalaman TikTok.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Trial signup attributed",
        value: "4.200",
        note: "TikTok bio link",
      },
  ...
  },
  {
    ...
    challenge:
      "Klinik gigi premium dengan treatment range Rp 2-25jt butuh trust signal kuat. Content lama generic (foto klinik + harga), engagement rendah. Dokter di klinik bagus tetapi tidak ada brand presence personal.",
    approach:
    ...
    results: [
      {
        metric: "Total follower 4 dokter",
        value: "+340.000",
        note: "vs 18k start",
      },
      { metric: "Booking via DM/bio", value: "+520%", note: "monthly" },
      {
        metric: "Trust score (survey)",
        value: "9.2/10",
        note: "patient survey",
      },
      {
        metric: "Treatment high-ticket",
        value: "+178%",
        note: "Veneer + implant",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Bengkel modifikasi premium punya skill + portfolio mantap tetapi IG hanya 18k follower. Customer didomination word-of-mouth grup WhatsApp komunitas. Mau scale tetapi kompetitor brand baru lebih agresif di IG.",
    approach:
  ...
  },
  {
    ...
    challenge:
      "Travel umroh premium dengan paket Rp 35-65jt punya repeat customer high (40%) tetapi acquisition new customer lambat. Kompetitor budget umroh Rp 18-25jt dominate awareness. Trust factor crucial untuk umroh, hard sell di socmed tidak efektif.",
    approach:
    ...
    results: [
      {
        metric: "TikTok follower",
        value: "184.000",
        note: "10 bulan from scratch",
      },
      {
        metric: "Booking via TikTok bio",
        value: "+340%",
        note: "attribution form",
      },
      {
        metric: "Repeat referral rate",
        value: "+62%",
        note: "social proof effect",
      },
      {
        metric: "Avg ticket size",
        value: "+18%",
        note: "trust → premium choice",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Fashion lokal D2C brand dengan price point Rp 350-800rb (mid-premium). IG editorial bagus tetapi sales tidak langsung correlate, TikTok belum eksplor. Founder ingin brand equity + sales sama-sama growth.",
    approach:
  ...
  },
  {
    ...
    challenge:
      "Fintech embedded finance B2B (serve enterprise client) butuh awareness di C-level audience. LinkedIn ada tetapi posting generic (press release). Sales team outbound aktif tetapi cold rate rendah. Need warm inbound channel.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Enterprise inbound demo",
        value: "+180%",
        note: "vs outbound only",
      },
      { metric: "Sales cycle reduction", value: "-34%", note: "warm vs cold" },
      {
        metric: "Deal closed from LinkedIn",
        value: "7 enterprise",
        note: "Rp 4.2M ARR",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Talent agency dengan 24 influencer (3-300k follower range). Tiap talent manage sendiri konten, kualitas + brand-fit per talent tidak konsisten. Brand deal acquisition dependent pada cold outreach, tidak ada portfolio leverage antar talent.",
    approach:
    ...
    results: [
      ...
      },
      {
        ...
        value: "23/24",
        note: "1 churn vs industry avg 30%",
      },
      {
        metric: "Multi-talent deal",
        value: "47% deal",
        note: "package > single",
      },
    ],
  ...
  // ============================================================
  {
    ...
    challenge:
      "Developer dengan 4 cluster aktif punya 9 vendor terpisah (SEO satu, Meta Ads lain, Google Ads lain, IG agency lain, dll). Attribution kacau, masing-masing claim sukses. Founder tidak ada single source of truth funnel. Booking fee stagnan 24/bulan padahal ad spend Rp 1.4M/bulan.",
    approach:
  ...
  },
  {
    ...
    challenge:
      "Klinik chain mau ekspansi agresif dari 4 ke 12 cabang dalam 18 bulan. Setiap cabang baru butuh ramp-up traffic ke break-even dalam 4 bulan. Playbook digital marketing untuk cabang baru tidak ada (semua trial-error).",
    approach:
    ...
    results: [
      {
        metric: "Cabang break-even",
        value: "3.2 bulan avg",
        note: "dari 6 bulan baseline",
      },
      {
        metric: "Member lifetime active",
        value: "+87%",
        note: "loyalty cross-branch",
      },
      { metric: "Revenue total network", value: "+340%", note: "18 bulan" },
      {
        metric: "Cabang sukses 18mo",
        value: "12/12",
        note: "0 failed expansion",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "EdTech founded by 2 ex-Big Tech tanpa marketing experience. Product strong, pricing competitive, tetapi tidak ada playbook GTM. Budget Rp 6M (Seed). Target: 12k paying student + metric ready Series A dalam 12 bulan.",
    approach:
  ...
  },
  {
    ...
    challenge:
      "F&B franchise coffee mau rollout 24 outlet di 16 kota dalam 14 bulan. Tantangan: brand awareness di kota tier-2-3 nol, franchisee training digital tidak ada, dan brand consistency lintas owner.",
    approach:
    ...
    results: [
      {
        metric: "Outlet break-even",
        value: "2.8 bulan avg",
        note: "vs SOP 5 bulan",
      },
      {
        metric: "Brand awareness kota tier-2",
        value: "62%",
        note: "post-launch survey",
      },
      {
        metric: "App user cross-outlet",
        value: "184.000",
        note: "loyalty engage",
      },
  ...
  },
  {
    ...
    results: [
      ...
      {
        metric: "Channel diversity",
        value: "5 channel",
        note: "dari 2 (ads only)",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Premium car dealer (price range Rp 800jt-2.5M) operates di 12 lokasi. Brand equity strong offline (showroom premium) tetapi digital presence weak. Lead from ads quality jelek (banyak tidak qualified), brand search rendah, dan event activation tidak measure.",
    approach:
  ...
  },
  {
    ...
    results: [
      {
        metric: "Inbound RFQ/bulan",
        value: "84",
        note: "dari 8 (outbound only)",
      },
      {
        metric: "Asian region buyer",
        value: "12 new client",
        note: "Vietnam, Thailand",
      },
      { metric: "Sales cycle reduction", value: "-32%", note: "warm inbound" },
      {
        metric: "Revenue from inbound",
        value: "Rp 28M/tahun",
        note: "incremental",
      },
    ],
  ...
  },
  {
    ...
    results: [
      {
        metric: "Unit sold 60 hari",
        value: "240/240",
        note: "100% phase 1 sold",
      },
      {
        metric: "NUP commitment pre-launch",
        value: "380",
        note: "oversubscribed",
      },
      {
        metric: "Cost per sold unit",
        value: "Rp 8.4jt",
        note: "vs target Rp 18jt",
      },
      {
        metric: "Revenue 60 hari",
        value: "Rp 360M",
        note: "fastest sold-out cluster",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Fintech payment B2B (target enterprise + UMKM) butuh growth tetapi vertical-nya highly regulated (BI + OJK). Marketing aggressive risk compliance issue + brand damage. Need balance growth speed dengan compliance.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Compliance issue",
        value: "0",
        note: "12 bulan zero violation",
      },
      {
        metric: "Transaction volume processed",
        value: "+340%",
        note: "via inbound clients",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Holding FMCG punya 6 brand (snack, beverage, household care). Tiap brand pakai agency berbeda-beda, cost duplikasi (CRM, analytics, creative production), dan data customer tersebar tidak ada single view.",
    approach:
    ...
    results: [
      {
        metric: "Marketing cost saving",
        value: "Rp 4.8M/tahun",
        note: "vs 6 agency terpisah",
      },
      { metric: "Cross-brand customer", value: "+47%", note: "LTV expansion" },
      {
        metric: "Total brand revenue",
        value: "+78%",
        note: "16 bulan vs baseline",
      },
      {
        metric: "Data unified records",
        value: "8.4 juta",
        note: "single view customer",
      },
    ],
  ...
  // ============================================================
  {
    ...
    challenge:
      "F&B chain dengan 28 outlet di Indonesia sukses tetapi visual identity lokal (Bahasa centric, color palette dated). Mau ekspansi ke Singapore + Malaysia, butuh brand yang travel well lintas budaya tanpa loose roots.",
    approach:
    ...
    results: [
      {
        metric: "Brand recall awareness",
        value: "+78%",
        note: "post-rebrand survey",
      },
      {
        metric: "Foot traffic outlets new visual",
        value: "+34%",
        note: "vs pre-rebrand",
      },
      {
        metric: "Ekspansi sukses SG/MY",
        value: "4 outlet",
        note: "Y1 post-rebrand",
      },
      {
  ...
  },
  {
    ...
    challenge:
      "Specialty coffee roastery di Bandung produce coffee bagus tetapi packaging masih plain kraft + sticker. Mau enter retail (supermarket premium + cafe partner) butuh shelf presence yang menarik dan storytelling per origin.",
    approach:
    ...
    results: [
      {
        metric: "Retail listing achieved",
        value: "82 store",
        note: "premium supermarket + cafe",
      },
      {
        metric: "Avg price per bag",
        value: "+44%",
        note: "premium pricing accepted",
      },
  ...
  },
  {
    ...
    challenge:
      "Developer butuh content video komprehensif untuk launch township 200ha. Vendor video sebelumnya hasilnya generic (drone showcase + voiceover umum), tidak ada storytelling. Budget kompetitif Rp 480jt untuk full package.",
    approach:
    ...
    results: [
      {
        metric: "Hero film YouTube views",
        value: "4.2 juta",
        note: "organic + ads",
      },
      {
        metric: "Social cut engagement",
        value: "+340%",
        note: "vs vendor lama",
      },
      {
        metric: "Booking fee post-video",
        value: "+178%",
        note: "30 hari post-launch",
      },
      {
        metric: "Vendor cost saving",
        value: "Rp 280jt",
        note: "vs 3 vendor terpisah",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Fashion D2C brand ingin brand equity premium tetapi visual content masih still product shoot (white background). Butuh lookbook seasonal untuk e-commerce + IG editorial yang kompete dengan brand established (Calla, Aere, Schmiley Mo).",
    approach:
    ...
    results: [
      ...
      {
        metric: "Revenue dari lookbook collection",
        value: "+178%",
        note: "vs sebelumnya",
      },
      {
        ...
        value: "+34%",
        note: "premium perception",
      },
      {
        metric: "Editorial feature",
        value: "8 publication",
        note: "Vogue ID, Tatler, dll",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Startup logistik B2B mau fundraising Series A (target USD 12M). Founder ex-VC tahu konten yang harus disampaikan tetapi visual masih minimum (PowerPoint default). Kompetitor fundraising barengan dengan deck yang very polished, butuh leverage visual edge.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Investor meeting taken",
        value: "47",
        note: "dari 24 outreach",
      },
      {
        metric: "Termsheet received",
        value: "6 firm",
        note: "competitive round",
      },
      {
        metric: "Diligence to close time",
        value: "5.4 minggu",
        note: "vs industry 12 mgg",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Fintech payment butuh content campaign yang edukatif (cara pakai feature, security, dll) tetapi product video sebelumnya boring (screen recording + voiceover). Engagement rendah, completion rate <20%.",
    approach:
      "Motion graphics style yang playful tetapi tetap professional: character-based explainer, custom illustration matching brand, dan storytelling per video (problem-solution). Deliverable: 16 video (8 edukasi + 4 how-to + 4 brand) dengan length 15-90 detik per platform.",
    results: [
      {
        metric: "Completion rate avg",
        value: "78%",
        note: "dari 18% screen recording",
      },
      {
        metric: "Total reach kampanye",
        value: "12.8 juta",
        note: "16 video combined",
      },
      {
        metric: "Feature adoption post-video",
        value: "+178%",
        note: "in-app event",
      },
  ...
  },
  {
    ...
    challenge:
      "Holding Tbk dengan 8 sub-brand operate dengan brand identity yang inkonsisten (logo variant beda-beda, color palette tiap divisi sendiri). Acquisition baru membuat makin chaos. Butuh brand book authoritative yang jadi referensi enterprise-wide.",
    approach:
      "Audit brand existing: collect semua variant + asset. Build brand architecture (master + endorser + co-brand). Identity refresh (tidak total rebrand, evolution). Brand book 120 halaman: usage guideline, voice + tone, application (office, signage, digital, packaging, vehicle), dan sub-brand framework.",
    results: [
      {
        metric: "Brand consistency score audit",
        value: "94%",
        note: "dari 38% pre",
      },
      {
        metric: "Subsidiary adoption",
        value: "8/8",
        note: "12 bulan post-launch",
      },
      {
        metric: "Cost saving design ops",
        value: "Rp 680jt/tahun",
        note: "less custom request",
      },
  ...
  },
  {
    ...
    challenge:
      "Skincare brand positioning sustainable tetapi packaging masih plastik konvensional (tidak match brand value). Mau redesign full lineup (24 SKU) dengan material refillable + biodegradable + tetap commercial viable di price point Rp 180-650rb.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Premium pricing accepted",
        value: "+34%",
        note: "vs sebelumnya",
      },
      {
        metric: "Award won",
        value: "2 design award",
        note: "incl Brand Indonesia Awards",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Lifestyle magazine 24-tahun pakai art direction internal yang dated (banyak free font, layout symmetrical, tidak ada brand visual personality). Mau rebrand + modernize tanpa kehilangan audience setia (avg umur 45+).",
    approach:
    ...
    results: [
      {
        metric: "Cover-to-cover read",
        value: "+47%",
        note: "subscriber survey",
      },
      {
        metric: "Subscription renewal",
        value: "92%",
        note: "industry avg 64%",
      },
      {
        metric: "Newsstand sell-through",
        value: "+34%",
        note: "premium positioning",
      },
      {
        metric: "Ad rate card increase",
        value: "+22%",
        note: "premium perceived value",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Korporasi energy Tbk publish sustainability report (ESG) yang dense 280 halaman. Engagement stakeholder rendah (90% download tetapi tidak baca). Butuh explainer animation yang summarize key metrics + komitmen sustainability dengan tone optimistic tetapi credible.",
    approach:
    ...
    results: [
      {
        ...
        value: "84%",
        note: "dari 18% pdf download",
      },
      {
        metric: "Stakeholder engagement",
        value: "+340%",
        note: "report awareness",
      },
      {
        metric: "Investor questions answered",
        value: "67%",
        note: "auto-answered via video",
      },
      {
        metric: "Award recognition",
        value: "ESG Communication Award",
        note: "industry assoc",
      },
    ],
  ...
  // ============================================================
  {
    ...
    challenge:
      "Klinik network 18 cabang dapat 12.000+ message WhatsApp/hari (booking, FAQ, complaint). Admin 6 orang tidak cukup, response time avg 4 jam (lost booking). 80% pertanyaan repetitive (jam buka, lokasi, harga treatment).",
    approach:
    ...
    results: [
      ...
      {
        metric: "Booking completed via chatbot",
        value: "+340%",
        note: "monthly",
      },
      {
        metric: "Admin redirect",
        value: "4 orang",
        note: "ke high-touch tasks",
      },
    ],
  ...
  },
  {
    ...
    approach:
      "AI bot stack: GPT-4 + product database + order management integration. Capability: order status real-time, size recommendation berdasarkan riwayat purchase + body data, return/refund flow self-service, dan escalation ke human jika frustrated detected (sentiment analysis).",
    results: [
      { metric: "Auto-resolved rate", value: "67%", note: "without human" },
      { metric: "Response time peak", value: "12 detik", note: "dari 6 jam" },
      {
        metric: "Size return rate",
        value: "11%",
        note: "dari 24% (size AI rec)",
      },
      {
        metric: "Customer satisfaction",
        value: "4.6/5",
        note: "post-chat survey",
      },
    ],
  ...
  },
  {
    ...
    results: [
      ...
      { metric: "Output volume", value: "+340%", note: "same team size" },
      {
        ...
        value: "4.8/5",
        note: "consistency improvement",
      },
      {
        metric: "Margin improvement",
        value: "+22 ppt",
        note: "lower cost per post",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Developer dapat 8.400+ lead/bulan dari multi-channel. Routing manual ke 320 agent tidak optimal (top agent burnout dengan lead jelek, junior agent tidak dapatkan lead bagus). Conversion lead-to-booking 4.2%, target 8%+.",
    approach:
    ...
    results: [
      ...
      {
        metric: "Senior agent productivity",
        value: "+78%",
        note: "deal/agent/bulan",
      },
      {
        metric: "Junior agent conversion",
        value: "+167%",
        note: "dapatkan lead apropriate",
      },
  ...
  },
  {
    ...
    challenge:
      "Law firm dengan 80 lawyer (junior - partner) habiskan 30%+ waktu untuk research case law historical. Knowledge tersebar di 12.000+ document Dropbox + Sharepoint. Junior lawyer susah cari preseden, partner tidak punya time mentor.",
    approach:
    ...
    results: [
      {
        metric: "Lawyer research time",
        value: "-67%",
        note: "vs manual search",
      },
      { metric: "Junior productivity", value: "+178%", note: "billable hours" },
      {
        metric: "Knowledge retention",
        value: "Centralized",
        note: "departing lawyer impact -78%",
      },
      {
        metric: "ROI 12 bulan",
        value: "4.8x",
        note: "investment vs billable saved",
      },
    ],
  ...
  },
  {
    ...
    results: [
      ...
      {
        metric: "Coach hours saved manager",
        value: "5 jam/minggu",
        note: "AI pre-screen",
      },
      {
        ...
        value: "+28%",
        note: "better objection handling",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "E-commerce dengan 12.000 product, deskripsi mostly copy-paste dari brand (generic, tidak SEO-optimized). Manual rewrite butuh 12 bulan + 8 content writer. SEO traffic stuck, internal team tidak punya bandwidth.",
    approach:
  ...
  },
  {
    ...
    challenge:
      "Marketplace UMKM dapatkan product photo dari seller dengan quality bervariasi (sebagian seller pakai HP biasa, lighting jelek, background distracting). Listing quality jelek membuat conversion rate marketplace rendah, tetapi tidak feasible suruh seller re-shoot.",
    approach:
    ...
    results: [
      {
        metric: "Image quality consistency",
        value: "94%",
        note: "passed marketplace QA",
      },
      {
        metric: "Marketplace conversion",
        value: "+78%",
        note: "post-enhancement",
      },
      {
        metric: "Cost vs manual editing",
        value: "-92%",
        note: "Rp 8rb/image vs Rp 95rb",
      },
      {
        metric: "Seller onboarding speed",
        value: "+340%",
        note: "less back-forth photo",
      },
    ],
  ...
  },
  {
    ...
    challenge:
      "Manufacturer otomotif dengan 1.800 karyawan + 2.400 SOP/technical document (mostly PDF + scan). Senior engineer aging (40%+ akan retire 5 tahun), tribal knowledge transfer tidak structured. Junior engineer butuh 18 bulan ramp-up.",
    approach:
    ...
    results: [
      {
        metric: "Engineer query response",
        value: "12 detik",
        note: "vs 2 jam manual",
      },
      {
        metric: "Junior ramp-up time",
        value: "8 bulan",
        note: "dari 18 bulan",
      },
      { metric: "SOP compliance audit", value: "98%", note: "external audit" },
      {
        metric: "Senior engineer time",
        value: "+34%",
        note: "redirected ke innovation",
      },
    ],
